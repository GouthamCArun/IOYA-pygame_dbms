...
class Player(pygame.sprite.Sprite):
    ...
    # Define your function to be called when the OK button is pressed
        ...
        if c==1:
            ...
            self.show_popup2("Yeeee!! internal marks are Boosted....")
            pygame.quit()
        else:
            print("Wrong submission")
            self.show_popup2("Ayooo!! Better luck next time....")
                ...
                if self.hitbox.colliderect(sprite.hitbox):
                    if isinstance(sprite,sprites.Tree):  
                        if sprite.name=='Small':
                            ...
                            n_id=npc_id. get_npc_id_by_name('chitra')
                            print('--------------------------You are near chitra miss')
                            print(n_id)
                            self.show_popup('You are near chitra miss',n_id)
                            

                        elif sprite.name=='Medium':
                            print('--------------------------You hit a veena')
                            n_id=npc_id. get_npc_id_by_name('veena')# Assuming your tree class is named 'Tree'
                            self.show_popup('You are near veena miss',n_id)
                        elif sprite.name=='Large':
                            print('--------------------------You hit a anisha')# Assuming your tree class is named 'Tree'
                            n_id=npc_id. get_npc_id_by_name('anisha')
                            print(n_id)
                            self.show_popup('You are near anisha miss',n_id)
